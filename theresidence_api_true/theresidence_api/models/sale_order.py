...
class SaleOrder(models.Model):
    ...
    def to_reservation_api_dict(self):
        ...
        return {
            ...
            'startTime': self.x_tr_start_time.strftime('%Y-%m-%dT%H:%M:%SZ') if self.x_tr_start_time else '',
            'endTime': self.x_tr_end_time.strftime('%Y-%m-%dT%H:%M:%SZ') if self.x_tr_end_time else '',
